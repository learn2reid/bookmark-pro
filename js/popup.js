...
var updateOnSave = false; // Flag Used to determine if we're creating a new or updating an existing bookmark
...
function getBookmarks() {
	...
	$(document).on('click', '.js-use-this-folder', function (e) {
		e.preventDefault();
		$('.js-select-folder').val($(this).data('id')).trigger('change');
	});
